...
class TestSubBytes(RijndaelTestBase):
    def test_sub_bytes_success(self):
        test_expected_success_value = (ctypes.c_ubyte * self.BLOCK_SIZE)(
    ...
    def test_sub_bytes_last_index(self):
        ...
        test_input = (ctypes.c_ubyte * self.BLOCK_SIZE)(0xFF)
...
class TestMixColumns(RijndaelTestBase):
    def test_mix_columns(self):
        ...
        block = (ctypes.c_ubyte * self.BLOCK_SIZE)(
            0xd4, 0xe0, 0xb8, 0x1e,
            0xbf, 0xb4, 0x41, 0x27,
            0x5d, 0x52, 0x11, 0x98,
            0x30, 0xae, 0xf1, 0xe5
        ...
        expected_block = (ctypes.c_ubyte * self.BLOCK_SIZE)(
            0x04, 0xe0, 0x48, 0x28,
            0x66, 0xcb, 0xf8, 0x06,
            0x81, 0x19, 0xd3, 0x26,
            0xe5, 0x9a, 0x7a, 0x4c
...
class TestInvertSubBytes(RijndaelTestBase):
    def test_invert_sub_bytes_success(self):
        ...
        test_input = (ctypes.c_ubyte * self.BLOCK_SIZE)(*transformed_sequence)
        expected_sequence = (ctypes.c_ubyte * self.BLOCK_SIZE)(*range(self.BLOCK_SIZE))
    ...
    def test_invert_sub_bytes_boundary_cases(self):
        ...
        test_input_first = (ctypes.c_ubyte * self.BLOCK_SIZE)(0x63)
        ...
        test_input_last = (ctypes.c_ubyte * self.BLOCK_SIZE)(0x16)
